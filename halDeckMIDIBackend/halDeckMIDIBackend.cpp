...
std::expected<halDeckMIDIBackend, std::string> halDeckMIDIBackend::create(unsigned long address, int port,
...
std::expected<halDeckMIDIBackend, std::string> halDeckMIDIBackend::create(const char* address, int port,
                                                                          const std::string& config_path)
{
    halDeckMIDIBackend hdmb(address, port);
    auto config = load_config(config_path);
